"""
Raw data from United States Environmental Protection Agency

1. calculate good data ratio:
    good day defined by AQI / number of total observations
2. drop unincorporated territory of US
3. concate years from 2018 to 2021 to one csv file
